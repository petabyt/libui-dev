...
ide.exe: $(IDE_FILES) libui_win64.a ide/ide.res
	$(CC) -static $(IDE_FILES) libui_win64.a /usr/x86_64-w64-mingw32/lib/liblua.a ide/ide.res $(LIBS) -Wl,-subsystem,windows -o ide.exe
...
ex.exe: example/main.c win.res libui_win64.a
	$(CC) -static example/main.c libui_win64.a win.res $(LIBS) -Wl,-subsystem,windows -o ex.exe

const.exe: const/const.c const/json.c win.res libui_win64.a
	$(CC) -static const/const.c const/json.c libui_win64.a win.res $(LIBS) -o const.exe

example.exe: example/main.c win.res libui_win64.a
	$(CC) -static example/main.c libui_win64.a win.res $(LIBS) -o example.exe
